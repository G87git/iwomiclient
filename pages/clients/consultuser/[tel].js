...
export default function Client_users() {
    ...
    //   };
      ...
      const columns = [
        ...
        { title: "Nom/Raison Sociale", dataIndex: "nomuser" },
        { title: "Type", dataIndex: "tprod", disableFilters: true  },
        { title: "Email", dataIndex: "emailuser", disableFilters: true },
        { title: "Téléphone", dataIndex: "tel" },
        { title: "NUI", dataIndex: "ncc" },
     //   { title: "Num de Compte", dataIndex: "compte", disableFilters: true },
        { title: "Date", dataIndex: "dou", disableFilters: true },
