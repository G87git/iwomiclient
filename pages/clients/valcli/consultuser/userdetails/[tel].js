...
export default function Consultclient(){
  ...
  return (
    ...
    {/* <PageLayout title="Gestions utilisateurs" Icon={FiUsers}> */}
      ...
      <h2 className="text-lg font-bold"  style={{ cursor: "pointer" }} onClick={() => router.back()}><ArrowLeftOutlined/> &nbsp;Consulter un Utilisatuer </h2>
